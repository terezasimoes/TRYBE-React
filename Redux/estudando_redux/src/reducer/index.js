...
// É essa key que define como o reducer vai manipular o estado.
  switch (action.type) {
    case 'ADD_ELEMENT':
      return [...state, action.value];// add itens na lista
    default:
      return state;
  }
}
...
elementos, caso o type seja igual a "ADDELEMENT", estamos instruindo 
nosso reducer a guardar todo o estado anterior, utilizando _spread operator,
 e a adicionar o novo elemento, que nesse caso está na key value 
 da nossa action. Caso o type seja diferente de "ADD_ELEMENT", 
